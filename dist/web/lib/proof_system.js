...
// internal API
export { CompiledTag, sortMethodArguments, getPreviousProofsForProver, GenericArgument, picklesRuleFromFunction, compileProgram, analyzeMethod, emptyValue, emptyWitness, synthesizeMethodArguments, methodArgumentsToConstant, methodArgumentTypesAndValues, isAsFields, snarkContext, inProver, inCompile, inAnalyze, inCheckedComputation, };
...
function compileProgram(publicInputType, methodIntfs, methods, proofSystemTag, additionalContext) {
    ...
    let [, { getVerificationKeyArtifact, provers, verify, tag }] = snarkContext.runWith({ inCompile: true, ...additionalContext }, () => Pickles.compile(rules, publicInputType.sizeInFields()));
